...
A statisztikák kiszámítása kizárólag a Web Workerben történjen, a fő szálon nem végezhető ilyen számítás.`,
        ...
        {
          text: `Egy tetszőlegesen választott és integrálnt charting library segítségével készíts egy egyszerű oszlopdiagramot a naponkénti bejegyzéseloszlásból.
...
valamint diagramon láthassa a fájlban leggyakrabban előforduló szavakat.`,
      subTasks: [
        {
          text: `Készíts fájlfeltöltő felületet az _ng-zorro_ Upload komponensével: https://ng.ant.design/components/upload/en.
...
A fájl feltöltése ne szerverre történjen, hanem kliensoldalon olvasd be a fájl tartalmát.`,
        ...
        {
          text: `A kiválasztott .txt fájl tartalmát jelenítsd meg egy jól elkülöníthető dobozban.
...
Jelenjen meg a fájl neve és a fájl mérete is.`,
        ...
        {
          text: `Készíts keresőmezőt, amelyben a felhasználó megadhat egy keresett szót vagy kifejezést.

A keresőmező értékének változására frissüljön a kiemelés a megjelenített szövegben.
Ennek megvalósításához integrálhatod például a mark.js (https://www.npmjs.com/package/mark.js) vagy más csomagot.
...
- az írásjeleket ne tekintsd a szó részének
- az üres elemeket hagyd figyelmen kívül

Határozd meg a 10 leggyakrabban előforduló szót majd írasd ki console-ra (_console.log_).`,
          xp: 1,
        },
        {
          text: `A 10 leggyakrabban előforduló szót jelenítsd meg pie chart diagramon egy tetszőleges
...
A diagram frissüljön automatikusan, amikor a felhasználó új fájlt választ ki.`,
        ...
        {
          text: `Adj a komponenshez vágólapra másolási funkciót.
